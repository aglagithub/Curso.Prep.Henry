...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  var promedio = 0;
  var numDatos = resultadosTest.length;
  for (var i = 0; i < numDatos; i++) {
    promedio += resultadosTest[i];
  }
  return promedio / numDatos;
}
...
function mesesDelAño(array) {
  ...
  // Tu código:
  var eneroEncontrado = false;
  var marzoEncontrado = false;
  var noviembreEncontrado = false;
  var arrayRetorno = [];

  for (var i = 0; i < array.length; i++) {
    mes = array[i].toUpperCase();
    if (mes === "ENERO") {
